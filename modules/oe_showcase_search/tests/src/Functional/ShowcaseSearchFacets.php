...
class ShowcaseSearchFacets extends BrowserTestBase {
  ...
  public function testSearchFacetsAreEnabled(): void {
    ...
    $assert_session->pageTextContains('search_api:views_page__showcase_search__showcase_search_page');
    // Assert that Facet Category exists.
    $assert_session->pageTextContains('category');
    // Assert that Facet Authored on exists.
    $assert_session->pageTextContains('published_on');
  ...
  public function testSearchFacetsSummaryIsConfigured(): void {
    ...
    $assert_session->checkboxChecked("facets[published_on][checked]");
    // Confirms Summary has Options enabled.
    $assert_session->checkboxChecked("facets[category][checked]");
