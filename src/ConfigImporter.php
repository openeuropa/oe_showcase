...
class ConfigImporter {
   ...
   *   The profile where the folder is located.
   * @param string $path
   *   The relative path to the folder, inside the profile.
   *
   * @return \Drupal\Core\Config\StorageInterface
   *   The config file storage.
   */
  protected static function getStorage(string $profile, string $path): StorageInterface {
    return new FileStorage(\Drupal::service('extension.list.module')->getPath($profile) . $path);
  }
